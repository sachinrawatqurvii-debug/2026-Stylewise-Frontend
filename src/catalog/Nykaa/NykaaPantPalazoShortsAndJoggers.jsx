...
const generateNykaaPantShortsPlazzoAndJoggers = (selectedData) => {
    const csvHeaders = [
        "Vendor SKU Code",
        "Gender",
        "Brand Name",
    ...
    const csvData = selectedData
        .filter((product) => product.styleType?.toLowerCase()?.trim() === "pant" || product.styleType?.toLowerCase()?.trim() === "palazzo" || product.styleType?.toLowerCase()?.trim() === "shorts" || product.styleType?.toLowerCase()?.trim() === "joggers" || product.styleType?.toLowerCase()?.trim() === "plazzo")
        .flatMap((product) =>
            sizes.map((size) => {
                ...
                return {
                    ...
                    "Bottoms Pants and Trousers Subcategory": subCategoryMapping[product?.styleType?.trim()] || product?.styleType,
