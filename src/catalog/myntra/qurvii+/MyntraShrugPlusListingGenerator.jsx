...
const generateMyntraShrugPlusListingFile = (selectedData) => {
    ...
    try {
        ...
        const csvData = selectedData
            .filter((product) => product.styleType.toLowerCase().trim() === "shrug" || product.styleType.toLowerCase().trim() === "shrugs" || product.styleType.toLowerCase().trim() === "cover" || product.styleType.toLowerCase().trim() === "poncho")
