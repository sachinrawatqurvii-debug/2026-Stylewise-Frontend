            ...
            {/* <div className='flex justify-between items-center'>
                ...
                <div className='flex flex-col gap-2 '>
                    <div className='flex gap-2 '>
                        <p className='p-2 bg-red-200 text-red-900 rounded-md'>Not Approved Styles : ( {not_approved.length} )</p>
                        <button onClick={showNotApprovedStyles} className='bg-blue-500 text-white cursor-pointer hover:bg-blue-600 duration-75 ease-in py-2 px-4 rounded-md'>Show Styles</button>
                    </div>
                    {show && (
                        <div className='w-40 bg-gray-200 p-2 rounded-md absolute top-40  '>
                            <ol>
                                {not_approved?.map((style) => (
                                    <li key={style._id}> {style.styleNumber} </li>
                                ))}
                            </ol>
                        </div>
                    )}
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {currentItems.length > 0 ? (
                            currentItems.map((style, i) => (
                                <tr key={`${style.styleNumber}-${i}`} className="hover:bg-gray-50 transition-colors">
