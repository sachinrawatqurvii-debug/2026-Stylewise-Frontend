...
const generateMyntraTopPlusListingFile = (selectedData) => {
            ...
            .flatMap((product, index) =>
                ...
                sizes.map((size) => {
                    ...
                    const productData = {
                        ...
                        "taxMaterial": "",
                        "Lining": (product.lining.toLowerCase().trim().includes("without") || product.lining.toLowerCase().trim().includes("without")) ? "NA" : "Has a lining",
