...
const generateMyntraTrousersPlusListingFile = (selectedData) => {
    ...
    try {
        ...
        const csvData = selectedData
            ...
            .filter((product) => product.styleType.toLowerCase().trim() === "pant" || product.styleType.toLowerCase().trim() === "joggers" || product.styleType.toLowerCase().trim() === "plazzo" || product.styleType.toLowerCase().trim() === "shorts" || product.styleType.toLowerCase().trim() === "short" || product.styleType.toLowerCase().trim() === "trouser")
